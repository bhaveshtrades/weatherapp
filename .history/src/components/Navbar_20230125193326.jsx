...
function Navbar({resultProp, cityProp}){
  ...
  return (
    <>
    <h1 className='text-slate-50 font-bold text-2xl mt-12 pl-8 md:inline'>Weather App</h1>
    ...
    <form role="search" onSubmit={resultProp} className='flex gap-x-2'>
        ...
        <button type="submit" className='btn btn-dark w-16 h-8 text-xs' onClick={resultProp}>Search</button>
    </form>
    </div>
    </>
  )
