...
function CurrentWeather(){
  ...
  return(
    ...
    <div className='mt-16 w-3/4 ml-52 pl-28 pt-4 h-72 currentWeatherDiv'>
    <div>
    ...
    <div className='bg-red-400 w-3/4 ml-52 h-64 forecastingDiv'>
    {hourlyData.length !== 0 && <div className='mt-4 ml-52 w-3/4 h-56 overflow-auto'>
    <h3 className='mt-4 bg-red-400'>Today's Weather</h3>
