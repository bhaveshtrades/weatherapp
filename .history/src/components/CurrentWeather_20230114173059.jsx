...
function CurrentWeather(){
  ...
  return(
    ...
    {hourlyData[0].map((element, index)=>{return (<HourlyForecast key={index} tempProp={element.temp_c} iconProp={element.condition.icon} timeProp={new Date(`${element.time}`).getHours()}/>)})}
    </div>
    </div>}
    </>
  )
