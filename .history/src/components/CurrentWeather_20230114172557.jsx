...
function CurrentWeather(){
  ...
  return(
    ...
    {hourlyData[0].map((element, index)=>(<HourlyForecast key={index} tempProp={element.temp_c} iconProp={element.condition.icon} timeProp={setTime(new Date(`${element.time}`).getHours())}/>))}
    </div>
    </div>}
    </>
  )
