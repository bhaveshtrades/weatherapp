...
function Navbar({resultProp, cityProp}){
  ...
  return (
    ...
    <form role="search" onSubmit={resultProp} className='flex gap-x-4'>
        <label htmlFor='cityName' className='text-slate-50 font-bold text-sm mt-2'>Enter City: </label>
        <input className='w-8 h-8' type='text' className='text-center' placeholder='Enter City Name' onChange={cityProp} id='cityName'/>
