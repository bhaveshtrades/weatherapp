...
function CurrentWeather(){
  ...
  return(
    ...
    {loading && <Loading/>}
    {weatherData.length !== 0 && loading !== true && <div className='mt-16 w-6/7 ml-8 h-72 currentWeatherDiv'>
    ...
    {weatherData.length !== 0 && loading!== true && <div className='w-6/7 ml-8 h-64 pl-8 hourlyForecastDiv md:pl-16'>
    ...
    {weatherData.length !== 0 && <div className='mt-4 w-6/7 ml-8 h-72 dailyForecastDiv overflow-auto mb-4'>
