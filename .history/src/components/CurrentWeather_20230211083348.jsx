...
function CurrentWeather(){
    ...
    const currentKey = process.env.REACT_APP_CURRENT_TOKEN;
    ...
    let currentLocationAPI = `https://api.weatherapi.com/v1/forecast.json?key=${currentKey}&q=${lat},${long}`;

    let dailyForeCastAPI = `https://api.openweathermap.org/data/2.5/forecast/daily?q=${city}&cnt=10&appid=${dailyForecastKey}`
    ...
    const months = ["January","February","March","April","May","June","July","August","September","October","November","December"]
        ...
        fetch(dailyForeCastAPI).then(data => data.json())
