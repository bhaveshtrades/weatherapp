...
function CurrentWeather(){
    ...
    const months = ["January","February","March","April","May","June","July","August","September","October","November","December"]
     ...
     function dailyForecasting(element, index){
        ...
        //   setTimeUnit('PM');
        // }
        setCorrectTime(new Date(`${element.time}`).getHours())
      return <HourlyForecast key={index} tempProp={element.temp_c} iconProp={element.condition.icon} timeProp={new Date(`${element.time}`).getHours()}/>
    }
