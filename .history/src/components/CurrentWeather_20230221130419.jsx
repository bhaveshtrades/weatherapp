...
function CurrentWeather(){
  ...
  return(
    ...
    {weatherData.length !== 0 && loading!==true && <div className='w-5/6 ml-8 h-64 hourlyForecastDiv md:pl-16'>
    <div className='mt-4 w-3/4 h-56 overflow-auto'>
    <h3 className='mt-4 text-lg md:text-xl'>Today's Weather</h3>
    <div className='flex gap-x-12 mt-4 overflow-auto hourlyForecastFlex ml-8'>
