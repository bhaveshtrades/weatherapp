...
function CurrentWeather(){
   ...
   const apiKey = process.env.REACT_APP_API_KEY;
    ...
    function dailyForecastData(element, index){
      ...
      return <DailyForecast key={index} dateProp={date} imgProp={element.day.condition.icon} tempProp={element.day.avgtemp_c} minTempProp={mintemp_c} maxTempProp={maxtemp_c}/>
    }
