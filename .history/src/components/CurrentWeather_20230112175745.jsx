...
function CurrentWeather(){
  ...
  return(
    ...
    <h4>{new Date(`${weatherData[0].current.last_updated}`).getDate()} {months[new Date(`${weatherData[0].current.last_updated}`).getMonth()]}, {new Date(`${weatherData[0].current.last_updated}`).getDay()}</h4>
    </div>
