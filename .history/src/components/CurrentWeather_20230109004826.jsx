...
function CurrentWeather({countryProp, locationProp, dayProp, dateProp, monthProp, currentIconProp, currentTempProp, currentStatusProp}){
  ...
  return(
    <>
    <Navbar resultProp={getWeather} cityProp={setCity((e)=>{e.target.value})}/>
    {weatherData.length !==0 && <div className='cDiv1'>
    <div className='cDiv6'>
    ...
    <div className='cDiv3'>
    <div className='cDiv4'>
    <img className='currentIcon' src={`${currentIcon}`} alt='This is a weather Icon'/>
    </div>
    <div className='cDiv5'>
