...
function CurrentWeather(){
   ...
   const apiKey = process.env.REACT_APP_API_KEY;
    ...
    function dailyForecastData(element, index){
      ...
      return <DailyForecast key={index} dateProp={date} imgProp={element.day.condition.icon} tempProp={element.day.avgtemp_c} minTempProp={element.day.mintemp_c} maxTempProp={element.day.maxtemp_c}/>
    }
  ...
  return(
    ...
    {weatherData.length !== 0 && loading!== true && <div className='w-4/5 ml-8 h-64 pl-8 hourlyForecastDiv md:pl-16'>
    ...
    {weatherData.length !== 0 && <div className='mt-4 w-4/5 ml-8 h-64 pl-8 dailyForecastDiv overflow-auto'>
    <h3 className='mt-4 text-lg'>3-Day Forecast</h3>
