...
function Navbar({resultProp, cityProp}){
  ...
  return (
    <>
    <h1 className='text-slate-50 font-bold text-lg mt-16 pl-8'>Weather App</h1>
    <div className='flex justify-around pl-4 mt-12'>
    <form role="search" onSubmit={resultProp} className='flex gap-x-4'>
        <label htmlFor='cityName' className='text-slate-50 font-bold text-sm mt-4'>Enter City: </label>
