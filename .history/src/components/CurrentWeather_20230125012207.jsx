...
function CurrentWeather(){
  ...
  return(
    ...
    {weatherData.length > 0 && <div className='mt-16 w-3/4 ml-52 pt-4 h-72 currentWeatherDiv'>
    <div>
    <h2 className='pl-28'>{weatherData[0].location.name}, {weatherData[0].location.country}</h2>
    ...
    <div className='w-3/4 ml-52 h-64 forecastingDiv'>
    {hourlyData.length > 0 && <div className='mt-4 ml-52 w-3/4 h-56 overflow-auto'>
