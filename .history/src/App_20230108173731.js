...
function App() {
  ...
  return (
    ...
    {weatherData.length !==0 && <CurrentWeather countryProp={country} locationProp={location} dayProp={weekDays[currentDay]} dateProp={currentDate} monthProp={months[currentMonth]}/>}
    </>
  );
}
