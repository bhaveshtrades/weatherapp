...
function App() {
  ...
  return (
    ...
    {/* <CurrentWeather countryProp={country} locationProp={location} dayProp={weekDays[currentDay]} dateProp={currentDate} monthProp={months[currentMonth]} currentIconProp={currentIcon} currentTempProp={currentTemp} currentStatusProp={currentStatus}/> */}
    <CurrentWeather/>
    </>
  );
}
